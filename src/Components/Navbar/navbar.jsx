...
const Navbar = () => {
  ...
  return (
    <div className='w-full bg-black text-white py-2'>
        ...
        {toggleMenu && (
            <div className='absolute w-full top-0 left-0 h-full z-10 bg-black flex items-center '
                onClick={()=>setToggleMenu(false)}>
                <div className='w-2/4  pl-3 flex flex-col gap-4 h-full text-white py-10'
        ...
        <div className='nav_group lg:py-5 lg:px-12 py-2 px-4  justify-between'>
            <div className='flex flex-row gap-4 items-center '>
                ...
                <div className='flex items-center justify-center text-xs'>
                    <NavLink
                        to='/'
                    >
                        <div className='hidden md:flex flex-col text-center nav_logo cursor-pointer'>
                            <h1 className='nav_logo_title'>PERFUMSTER</h1>
                            <h1 className='nav_logo_subtitle'>Decanted Perfumes</h1>
                        </div>
                    </NavLink>
            ...
            <div className='flex flex-row justify-center items-center gap-6'>
                ...
                <div className='flex flex-row items-center justify-center gap-x-5'>
                    <ul className='hidden lg:flex flex-row justify-center items-center gap-10'>
                        <NavLink
                            to='/new'
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) => (isActive ? 'text-blue-500' : 'text-white')}
                        >
                            <li className='nav_item'>For Him</li>
                        </NavLink>
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) => (isActive ? 'text-blue-500' : 'text-white')}
                        >
                            <li className='nav_item'>For Her</li>
                        </NavLink>
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) => (isActive ? 'text-blue-500' : 'text-white')}
                        >
                            <li className='nav_item'>Subscription</li>
                        </NavLink>
                    </ul>
                </div>
