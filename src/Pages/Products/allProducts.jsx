    ...
    {filterSelected && (
      <div className='absolute top-0 left-0 w-full h-auto bg-[rgb(2,2,2)] z-50 text-white'>
        <div className='w-11/12 mx-auto py-10'>
          <div class="slider-container w-3/4 pb-10 ">
            <div class="price-display text-lg mb-4">
              Price: $<span id="price-value" class="font-semibold">{selectedPrice}</span>
            </div>
            <div class="flex items-center justify-between mb-2">
              <span class="text-gray-500">$0</span>
              <span class="text-gray-500">$500</span>
            </div>
            <input type="range" min="0" max="500" value={selectedPrice}  id="price-slider" 
                  class="w-full h-2 rounded-lg bg-white appearance-none cursor-pointer slider-range" 
          ...
          <div className='w-3/4 flex flex-col gap-2 text-md'>
              ...
              <div className='flex flex-row gap-2'>
                  <div className={`flex-1 border p-2 px-4 text-center ${sizeSelected ==='5ml' ? 'bg-white text-black' : 'bg-transparent text-white'} cursor-pointer`}
                    onClick={()=>setSizeSelected('5ml')}>
                    <span className='helvetica' >5 ml</span>
                  </div>

                  <div className={`flex-1 border p-2 px-4 text-center ${sizeSelected ==='10ml' ? 'bg-white text-black' : 'bg-transparent text-white'} cursor-pointer`}
          ...
          <div className='bg-white text-black p-2 px-5 text-center'
