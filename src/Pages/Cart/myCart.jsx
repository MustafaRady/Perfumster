    ...
    <>
            ...
            <div className='flex md:flex-row flex-col gap-y-5  '>
              ...
              <div className='flex-1 flex md:justify-center items-center flex-row gap-4'>
                ...
                <div className='flex flex-row gap-2 p-1 px-2 w-28 border justify-between'>
                  <span onClick={handleDecreaseQuantity()} className='cursor-pointer'>-</span>
                  <span>{element.quantity}</span>
                  <span onClick={handleIncreaseQuantity()} className='cursor-pointer'>+</span>
                </div>
              </div>

              <div className='flex-1 flex flex-row items-center md:justify-end gap-3'>
                <span>${element.price}</span>
                <div className='border p-1 cursor-pointer' onClick={handleDelete(index)}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                    <path d="M7.5835 22.75C6.98766 22.75 6.47777 22.538 6.05383 22.1141C5.62988 21.6901 5.41755 21.1799 5.41683 20.5833V6.5H4.3335V4.33333H9.75016V3.25H16.2502V4.33333H21.6668V6.5H20.5835V20.5833C20.5835 21.1792 20.3715 21.6894 19.9476 22.1141C19.5236 22.5388 19.0134 22.7507 18.4168 22.75H7.5835ZM18.4168 6.5H7.5835V20.5833H18.4168V6.5ZM9.75016 18.4167H11.9168V8.66667H9.75016V18.4167ZM14.0835 18.4167H16.2502V8.66667H14.0835V18.4167Z" fill="white" style={{fill:'white',fillOpacity:1}}/>
                  </svg>
                </div>
              </div>
            </div>
      ...
      <div className='w-4/5 mx-auto flex flex-col justify-end items-end mt-2 gap-3'>
        ...
        <div className='flex md:flex-row flex-col gap-2 items-end'>
          ...
          <span className='text-3xl'>${perfumes.reduce((sum,item)=>sum + item.price , 0)}</span>
        </div>
