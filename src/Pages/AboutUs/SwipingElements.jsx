...
const SwipingElement =({perfume , color})=>{
    return (
        <div className={` h-44 w-20 md:h-52 md:w-24 lg:h-72 lg:w-36 rounded-t-full rounded-b-full  flex items-center justify-center`} style={{ backgroundColor: color }}>
            <img src={perfume} alt="" />
        </div>
    )
}
...
const SwipingElements = () => {
    ...
    const perfumes = [
    { name: Perfume1, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume2, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume3, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume4, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume5, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume6, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume7, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume8, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume1, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume2, color: colors[Math.floor(Math.random() * colors.length)] },
    { name: Perfume3, color: colors[Math.floor(Math.random() * colors.length)] },
    ];
